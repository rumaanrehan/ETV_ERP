...
export class CreateComponent implements OnInit, OnDestroy {
  ...
  closeSidebar(): void {
    ...
    this.formService.resetFormValue<ExportOrderPayment>(this.formConfig, this.form);
  ...
  createRecord(model: ExportOrderPayment): void {
    try {
      this.pageService
        .CreateRecord(model)
  ...
  updateRecord(model: ExportOrderPayment): void {
    try {
