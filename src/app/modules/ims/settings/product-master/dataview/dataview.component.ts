...
import { Product_IndexTableFilter, Product_IndexTableList, Product_IndexTableSort } from '../product-master';
...
export class DataviewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  dataViewDef!: DataViewDef<Product_IndexTableList>;
  ...
  private loadData(): void {
    ...
    const model: DataViewParams<Product_IndexTableFilter, Product_IndexTableSort> = {
  ...
  onClickDeleteReactivate(item: Product_IndexTableList): void {
