...
import { Manufacturer_IndexTableFilter, Manufacturer_IndexTableList, Manufacturer_IndexTableSort } from '../manufacturer-master';
...
export class DataviewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  dataViewDef!: DataViewDef<Manufacturer_IndexTableList>;
  ...
  private loadData(): void {
    ...
    const model: DataViewParams<Manufacturer_IndexTableFilter, Manufacturer_IndexTableSort> = {
  ...
  onClickDeleteReactivate(item: Manufacturer_IndexTableList): void {
