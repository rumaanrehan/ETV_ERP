...
export class ReportTemplateService {
  ...
  PopulateList(PopulateType: any): Observable<ApiListResponse<ReportTemplateMasterList>> {
    return this.http.post<ApiListResponse<ReportTemplateMasterList>>(`${this.apiUrl}RD/ReportTemplateMaster/PopulateList?PopulateType=${PopulateType}`, {});
  }

  PopulateList1(ServiceCategoryID: number | null ,PopulateType: any): Observable<ApiListResponse<ReportTemplateMasterList>> {
    return this.http.post<ApiListResponse<ReportTemplateMasterList>>(`${this.apiUrl}RD/ReportTemplateMaster/PopulateList?ServiceCategoryID=${ServiceCategoryID}&PopulateType=${PopulateType}`, {});
  }

  PopulateGrid(tabledata: any): Observable<ApiPagedListResponse<ReportTemplateMasterList>> {
    return this.http.post<ApiPagedListResponse<ReportTemplateMasterList>>(`${this.apiUrl}RD/ReportTemplateMaster/PopulateGrid`, tabledata);
  }

  GetDetails(ReportTemplateID: number): Observable<ApiDataResponse<ReportTemplateMaster>> {
    return this.http.post<ApiDataResponse<ReportTemplateMaster>>(`${this.apiUrl}RD/ReportTemplateMaster/GetDetails?ReportTemplateID=${ReportTemplateID}`, {});
  }

  CreateRecord(model: ReportTemplateMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(`${this.apiUrl}RD/ReportTemplateMaster/Create`, model);
  }

  UpdateRecord(model: ReportTemplateMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(`${this.apiUrl}RD/ReportTemplateMaster/Edit`, model);
  }

  DeleteRecord(model: ReportTemplateMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(`${this.apiUrl}RD/ReportTemplateMaster/Delete`, model);
  }
}
