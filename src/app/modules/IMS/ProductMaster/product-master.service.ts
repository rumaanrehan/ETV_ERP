...
export class ProductMasterService {
  ...
  // private endpoint = "api/Admin/ProductMaster"
  // private endpoint = 'https://localhost:44316/api/Admin/IMS/ProductMaster';
  ...
  GetStaticList(
    model: StaticListRequest
  ): Observable<ApiListResponse<StaticList>> {
  ...
  PopulateGrid(
    model: DataTableParams<ProductMaster_IndexTableFilter>
  ): Observable<ApiPagedListResponse<ProductMaster_IndexTableList>> {
    // console.log(this.apiService.post<
    //   ApiPagedListResponse<ProductMaster_IndexTableList>
    // >(`${this.endpoint}/PopulateGrid`, model))
  ...
  GetDetails(productID: number): Observable<ApiDataResponse<ProductMaster>> {
    return this.apiService.post<ApiDataResponse<ProductMaster>>(
      `${this.endpoint}/GetDetails?productID=${productID}`,
      {}
    );
  }
