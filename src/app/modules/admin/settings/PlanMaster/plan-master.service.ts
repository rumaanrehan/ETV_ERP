...
import {
  Operator,
  RequiredIf,
} from '../../../../shared/validators/required-if.validator';
import {
  PlanMaster,
  PlanMaster_BillTypeMappingList,
  PlanMaster_IndexTableFilter,
  PlanMaster_IndexTableList,
...
export class PlanMasterService {
  ...
  PopulateList(
    PopulateType: any
  ): Observable<ApiListResponse<PlanMaster_SelectList>> {
    return this.http.post<ApiListResponse<PlanMaster_SelectList>>(
      `${this.apiUrl}Admin/PlanMaster/PopulateList?PopulateType=${PopulateType}`,
      {}
    );
  }

  PopulateGrid(
    model: DataTableParams<PlanMaster_IndexTableFilter>
  ): Observable<ApiPagedListResponse<PlanMaster_IndexTableList>> {
    return this.http.post<ApiPagedListResponse<PlanMaster_IndexTableList>>(
      `${this.apiUrl}Admin/PlanMaster/PopulateGrid`,
      model
    );
  }

  GetDetails(PlanID: number): Observable<ApiDataResponse<PlanMaster>> {
    return this.http.post<ApiDataResponse<PlanMaster>>(
      `${this.apiUrl}Admin/PlanMaster/GetDetails?PlanID=${PlanID}`,
      {}
    );
  }

  GetDetailsBillTypeMapping(
    PlanID: number | null
  ): Observable<ApiListResponse<PlanMaster_BillTypeMappingList>> {
    return this.http.post<ApiListResponse<PlanMaster_BillTypeMappingList>>(
      `${this.apiUrl}Admin/PlanMaster/GetDetailsBillTypeMapping${
  ...
  CreateRecord(model: PlanMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(
      `${this.apiUrl}Admin/PlanMaster/Create`,
      model
    );
  }
  ...
  UpdateRecord(model: PlanMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(
      `${this.apiUrl}Admin/PlanMaster/Edit`,
      model
    );
  }
  ...
  DeleteRecord(model: PlanMaster): Observable<ApiResponse> {
    return this.http.post<ApiResponse>(
      `${this.apiUrl}Admin/PlanMaster/Delete`,
      model
    );
  }
      ...
      BillTypeMapping: {
        ...
        items: {
          ...
          DefaultBillType: {
            ...
            validationMessages: {
              required:
                'Please select an option from the Default Bill Type List.',
            },
            type: 'control',
          },
          ...
          OP_ReturnAllowed_BasedOn: {
            ...
            validationMessages: {
              required:
                'Please select an option from the OP Return Allowed Based On List.',
            },
            type: 'control',
          },
          ...
          IP_BillingAllowed_BasedOn: {
            ...
            validationMessages: {
              required:
                'Please select an option from the IP Billing Allowed Based On List.',
            },
            type: 'control',
          },
          IP_BillingAllowed_BasedOn_Days: {
            ...
            defaultValue: null,
            validators: [
              RequiredIf('IP_BillingAllowed_BasedOn', Operator.GreaterThan, 2),
            ],
            validationMessages: {
          ...
          IP_ReturnAllowed_BasedOn: {
            ...
            validationMessages: {
              required:
                'Please select an option from the IP Return Allowed Based On List.',
            },
            type: 'control',
          },
          IP_ReturnAllowed_BasedOn_Days: {
            ...
            defaultValue: null,
            validators: [
              RequiredIf('IP_ReturnAllowed_BasedOn', Operator.GreaterThan, 2),
              NotOnlyWhitespaceValidator(),
            ],
            validationMessages: {
