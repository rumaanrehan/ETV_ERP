...
export class IndexComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('planCodeTemplate', { static: true })
  planCodeTemplate!: TemplateRef<any>;
  @ViewChild('planIsAllowedForOPTemplate', { static: true })
  planIsAllowedForOPTemplate!: TemplateRef<any>;
  @ViewChild('planIsAllowedForIPTemplate', { static: true })
  planIsAllowedForIPTemplate!: TemplateRef<any>;
  @ViewChild('planIsPreAuthorizationRequiredTemplate', { static: true })
  planIsPreAuthorizationRequiredTemplate!: TemplateRef<any>;
  @ViewChild('planIsDefaultTemplate', { static: true })
  planIsDefaultTemplate!: TemplateRef<any>;
  @ViewChild('planActiveStatusTemplate', { static: true })
  planActiveStatusTemplate!: TemplateRef<any>;
  ...
  ngOnInit(): void {
    ...
    this.tableDef = {
      ...
      filterForm:
        this.formService.createFormGroup_DataTableFilter<PlanMaster_IndexTableFilter>(
    ...
    this.tableDef.columnDef = [
      ...
      { data: 'PlanID', visible: false, hideVisToggle: true, orderable: false },
      {
        ...
        filterable: true,
        width: '5%',
        customTemplate: this.planCodeTemplate,
      },
      { data: 'PlanName', label: 'Plan Name', filterable: true },
      {
        data: 'BillCompanyName',
        label: 'Bill Company',
        width: '20%',
        filterable: true,
        filterType: 'select',
        filterKey: 'BillCompanyID',
      },
      {
        data: 'PlanTypeName',
        label: 'Plan Type',
        ...
        filterable: true,
        filterType: 'select',
        filterKey: 'PlanTypeID',
      },
      {
        data: 'IsAllowedForOP',
        label: 'OP Registration',
        groupLabel: 'Allowed For',
        orderable: false,
        cssClass: 'text-center',
        width: '7%',
        customTemplate: this.planIsAllowedForOPTemplate,
      },
      {
        data: 'IsAllowedForIP',
        ...
        cssClass: 'text-center',
        width: '7%',
        customTemplate: this.planIsAllowedForIPTemplate,
      },
      {
        data: 'IsPreAuthorizationRequired',
        label: 'Is Pre-Authorization Required',
        orderable: false,
        cssClass: 'text-center',
        width: '15%',
        customTemplate: this.planIsPreAuthorizationRequiredTemplate,
      },
      {
        data: 'IsDefault',
        label: 'Is Default',
        ...
        cssClass: 'text-center',
        width: '5%',
        customTemplate: this.planIsDefaultTemplate,
      },
      {
        data: 'ActiveStatus',
        label: 'Status',
        ...
        cssClass: 'text-center',
        width: '5%',
        customTemplate: this.planActiveStatusTemplate,
      },
      {
        data: '',
        hideVisToggle: true,
