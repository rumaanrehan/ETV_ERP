...
import { TaxSlab_IndexTableFilter, TaxSlab_IndexTableList, TaxSlab_IndexTableSort } from '../tax-slab-master';
import { TaxSlabMasterService } from '../tax-slab-master.service';

@Component({
  selector: 'app-tax-slab-dataview',
  standalone: true,
...
export class DataviewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  dataViewDef!: DataViewDef<TaxSlab_IndexTableList>;
  ...
  private loadData(): void {
    ...
    const model: DataViewParams<TaxSlab_IndexTableFilter, TaxSlab_IndexTableSort> = {
