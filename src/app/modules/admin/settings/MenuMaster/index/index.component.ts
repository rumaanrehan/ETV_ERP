...
export class IndexComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.tableDef.columnDef = [
      ...
      { data: 'MenuID', label: 'Menu ID', filterable: false},
      { data: 'MenuName', label: 'Menu Name', customTemplate: this.menuNameTemplate },
      { data: 'ModuleName', label: 'Module' },
      { data: 'MenuTypeName', label: 'Menu Type', filterable: false, orderable: false },
      { data: 'ParentMenuName', label: 'Parent', filterable: false, orderable: false },
      { data: 'ControllerName', label: 'Controller', orderable: false },
      { data: 'ActionName', label: 'Action', filterable: false, orderable: false },
      { data: 'DisplayOrder', label: 'Display Order', filterable: false, orderable: false },
      { data: 'IsDeveloperOnly', label: 'IsDeveloper', orderable: false, customTemplate: this.isDeveloperOnlyTemplate },
      { data: 'ActiveStatus', label: 'Status', filterable: true, filterType: 'select', filterKey: 'ActiveStatusID', cssClass: 'text-center', width: "10%", customTemplate: this.menuMasterActiveStatusTemplate },
