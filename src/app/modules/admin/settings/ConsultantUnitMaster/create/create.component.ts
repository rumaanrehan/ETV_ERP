...
export class CreateComponent implements OnInit, OnDestroy {
  ...
  DepartmentsList: Department_SelectList[] = [];
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.form = this.formService.createFormGroup<ConsultantUnitMaster>(this.formConfig);
  ...
  loadDepartment(): void {
    try
    {
      const dto: DepartmentRequest = {
        PopulateType: 'SelectList'
      }
      this.departmentService.PopulateList(dto)
  ...
  openSidebar(ActiveStatus: boolean, isEditMode: boolean, model: ConsultantUnitMaster): void {
    if (isEditMode && model) {
  ...
  closeSidebar(): void {
    ...
    this.formService.resetFormValue<ConsultantUnitMaster>(this.formConfig, this.form);
    setTimeout(() => {
  ...
  createRecord(model: ConsultantUnitMaster): void {
    try {
  ...
  updateRecord(model: ConsultantUnitMaster): void {
    try {
