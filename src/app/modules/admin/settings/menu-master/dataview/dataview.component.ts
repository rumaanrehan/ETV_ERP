...
import { MenuMaster_IndexTableFilter, MenuMaster_IndexTableList, MenuMaster_IndexTableSort } from '../menu-master';
...
export class DataviewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  dataViewDef!: DataViewDef<MenuMaster_IndexTableList>;
  ...
  private loadData(): void {
    ...
    const model: DataViewParams<MenuMaster_IndexTableFilter, MenuMaster_IndexTableSort> = {
  ...
  onClickDeleteReactivate(item: MenuMaster_IndexTableList): void {
