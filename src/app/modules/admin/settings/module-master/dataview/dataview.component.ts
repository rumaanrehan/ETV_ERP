...
import { ModuleMaster_IndexTableFilter, ModuleMaster_IndexTableList, ModuleMaster_IndexTableSort } from '../module-master';
...
export class DataviewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  dataViewDef!: DataViewDef<ModuleMaster_IndexTableList>;
  ...
  private loadData(): void {
    ...
    const model: DataViewParams<ModuleMaster_IndexTableFilter, ModuleMaster_IndexTableSort> = {
  ...
  onClickDeleteReactivate(item: ModuleMaster_IndexTableList): void {
