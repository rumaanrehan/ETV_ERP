...
export class IndexComponent implements OnInit, OnDestroy {
  ...
  tableDef!: IndexTableParams<RoleMasterList>;
  ...
  ngOnInit(): void {
    ...
    this.tableDef.columnDef = [
      ...
      { data: 'RoleCode', label: 'Code', customTemplate: this.roleCodeTemplate },
      { data: 'RoleName', label: 'Role Name' },
      { data: 'ActiveStatus', label: 'Status', cssClass: 'text-center', customTemplate: this.roleActiveStatusTemplate },
  ...
  onClickPageHeaderMapButton(): void {
    this.router.navigate(['/Admin/RolePerimssion/Index']);
  }

  onClickEditDetails(RoleID: number, ActiveStatus: boolean) {
    try {
          ...
          .subscribe({
            next: (response) => {
              if (response.IsSuccess) {
                ...
                console.log('khjbsd',response.Data)
              }
              else {
                this.alertService.showServerResponseAlert(response);
              }
